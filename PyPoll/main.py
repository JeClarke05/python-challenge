...
text_file.write(f'-----------------------\n')
text_file.write(f'Total Votes: {str(num_of_votes)}\n')
text_file.write(f'-----------------------\n')
text_file.write(f'{can1}: {str("{:.3%}".format(can1Percent))} ({str(can1Count)})\n')
text_file.write(f'{can2}: {str("{:.3%}".format(can2Percent))} ({str(can2Count)})\n')
text_file.write(f'{can3}: {str("{:.3%}".format(can3Percent))} ({str(can3Count)})\n')
text_file.write(f'{can4}: {str("{:.3%}".format(can4Percent))} ({str(can4Count)})\n')
text_file.write(f'-----------------------\n')
